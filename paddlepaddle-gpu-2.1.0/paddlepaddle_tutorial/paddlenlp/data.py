'''
Author: your name
Date: 2021-07-16 14:10:21
LastEditTime: 2021-07-16 14:14:47
LastEditors: Please set LastEditors
Description: In User Settings Edit
FilePath: /DeepLearningFramework/paddlepaddle-gpu-2.1.0/paddlepaddle_tutorial/paddlenlp/data.py
'''
    ...
    def dump_vocab(self, unk_token, pad_token):
        with open(self.vocab_path, "w", encoding="utf8") as f:
            for word in self.vocab._token_to_idx:
                f.write(word + "\n")
    ##词向量与词向量词库保持一致 不管是采用什么词向量训练方式 glove fasttext word2vec
